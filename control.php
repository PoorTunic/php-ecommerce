...
<body style="background-color: #F5F5F5">
    ...
    <div>
        <nav class="navbar navbar-dark bg-dark text-white">
            <div class="collapse navbar-collapse d-flex flex-row-reverse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item mb-3 h3">
                        <font face="Darker Grotesque">
    ...
    <div>
        <div class="row">
            <div class="col-sm">
                <font face="Darker Grotesque">
                <div class="btn-group-vertical bg-dark" role="group" aria-label="Basic example">
            ...
            <div class="col-sm">
                <font face="Darker Grotesque" size="6">
