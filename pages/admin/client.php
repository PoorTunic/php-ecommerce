        ...
        if($sinres){
          ...
          while($row=mysqli_fetch_assoc($result)){
            ...
            echo '<tr>
                    ...
                    <td>'.$row['telefono1'].'</td>
                    <td>'.$row['correo1'].'</td>
                    <td><button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#infoModal'.$row['id_cliente'].'" data-whatever="cliente">Detalles</button></td>
      ...
      echo '<script>
           ...
           echo '<div class="modal fade" id="infoModal'.$id.'" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel'.$id.'" aria-hidden="true">
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       <div class="modal-header">
                         <h5 class="modal-title" id="infoModalLabel'.$id.'">Ver detalles de cliente</h5>
                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                           <span aria-hidden="true">&times;</span>
                         </button>
                       </div>
