...
<body class="container">
    ...
    <div class="container col-8 col-sm-8 col-md-6 col-lg-5 col-xl-4 mx-auto border rounded" style="padding-top: 5%;background: #4257B1;">
        <h1 class="text-center" style="color: white">Especificar datos de entrega</h1>
        <form action="delivery.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="email" readonly value="<?= $_POST['correo'] ?>" class="form-control" name="correo1" placeholder="Correo de contacto 1" required maxlength="60">
          </div>
          <div class="form-group">
          ...
          <div class="jumbotron text-center justify-content-center" style="background: #586FD4;">
            <button name="terminar" type="submit" class="btn btn-light col-3 col-sm-3 col-md-4 col-lg-4 col-xl-4" style="font-size: 14px;">Terminar registro</button>
          </div>
        </form>
      </div>
      <?php
